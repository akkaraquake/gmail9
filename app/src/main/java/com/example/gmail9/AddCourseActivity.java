...
public class AddCourseActivity extends AppCompatActivity {
    ...
    private void addCourse() {
        if (isValidInput()) {
            ...
            dbHelper.insertDetails(courseName, courseFee, startingDate, registrationCloseDate, maxParticipants, selectedDuration);
    ...
    private void updateCourse() {
        ...
        if (isValidInput()) {
            ...
            dbHelper.updateCourse(courseName, courseFee, startingDate, registrationCloseDate, maxParticipants, selectedDuration);
